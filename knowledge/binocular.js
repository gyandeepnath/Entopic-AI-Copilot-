...

{
  ...
  "route": "binocular",
  "req": ["near_strain"],
  "sup": ["headache_near", "difficulty_reading", "double_vision_near", "fatigue", "losing_place_reading", "worse_evening", "asthenopia", "eye_strain", "near_blur"],
...

{
  ...
  "route": "binocular",
  "req": ["eso_near"],
  "sup": ["near_blur", "headache", "eye_strain", "near_strain", "asthenopia", "worse_evening", "difficulty_reading", "hyperopia"],
...

{
  ...
  "route": "binocular",
  "req": ["near_blur"],
  "sup": ["difficulty_focusing", "fatigue", "reduced_amplitude", "difficulty_reading", "headache_near", "asthenopia", "worse_evening", "near_strain"],
