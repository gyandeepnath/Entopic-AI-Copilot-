...

{
  ...
  "sup": ["redness", "ciliary_flush", "reduced_vision", "cells_2", "cells_3", "flare_2", "flare_3"],
...

{
  ...
  "sup": ["pain_severe", "photophobia", "redness", "reduced_vision", "cells_4", "flare_4"],
  "con": [],
  "temporal": ["acute"],
   ...
   tokens, urgency flags and the scleritis→episcleritis exclusion. */
{
  ...
  "sup": ["post_surgery", "hypopyon_visible", "redness", "photophobia", "lid_swelling_diffuse", "vision_hazy", "cells_4", "flare_4"],
  "con": [],
  "temporal": ["acute"],
