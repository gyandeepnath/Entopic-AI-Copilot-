...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 106 loaded files (85 in `js/`, 21 in
`knowledge/`), 394 conditions across 9 domains, 74 test files.
...
**Root** — `index.html` (575), `css/entopic.css` (2595)
