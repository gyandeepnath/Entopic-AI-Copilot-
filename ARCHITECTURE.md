...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 109 loaded files (87 in `js/`, 22 in
`knowledge/`), 394 conditions across 9 domains, 77 test files.
...
**Root** — `index.html` (581), `css/entopic.css` (2601)

**`/knowledge`** — 22 files, loaded first, in this order:
...
**`/js`** — 87 files, in load order:

- `dom-escape.js` (67)
- `build-info.js` (78)
- `browser-io.js` (101)
- `kb-authoring.js` (312)
- `data-classification.js` (182)
- `events.js` (86)
- `data-model.js` (1275)
- `wnl-templates.js` (67)
...
- `feedback.js` (257)
- `storage.js` (811)
- `storage-backup.js` (386)
- `visit-history.js` (212)
- `clinical-contradictions.js` (204)
- `kb-overlay.js` (361)
- `competency.js` (311)
- `ui-trends.js` (88)
