...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 107 loaded files (86 in `js/`, 21 in
`knowledge/`), 394 conditions across 9 domains, 76 test files.
...
**Root** — `index.html` (577), `css/entopic.css` (2595)
