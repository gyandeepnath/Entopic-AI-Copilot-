...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 121 loaded files (98 in `js/`, 23 in
`knowledge/`), 394 conditions across 9 domains, 89 test files.
...
**Root** — `index.html` (677), `css/entopic.css` (2604)
...
**`/js`** — 98 files, in load order:

- `dom-escape.js` (67)
- `build-info.js` (78)
- `browser-io.js` (101)
- `kb-authoring.js` (312)
- `data-classification.js` (238)
- `events.js` (86)
- `data-model.js` (1275)
- `wnl-templates.js` (67)
- `section-status.js` (208)
- `ui-section-status.js` (127)
- `storage-mirror.js` (318)
- `local-vault.js` (800)
