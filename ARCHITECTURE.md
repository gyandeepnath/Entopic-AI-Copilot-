...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 123 loaded files (100 in `js/`, 23 in
`knowledge/`), 394 conditions across 9 domains, 91 test files.
...
**Root** — `index.html` (685), `css/entopic.css` (2604)
