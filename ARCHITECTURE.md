...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 113 loaded files (90 in `js/`, 23 in
`knowledge/`), 394 conditions across 9 domains, 80 test files.
...
**Root** — `index.html` (592), `css/entopic.css` (2601)
