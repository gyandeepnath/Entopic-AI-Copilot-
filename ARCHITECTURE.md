...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 103 loaded files (82 in `js/`, 21 in
`knowledge/`), 394 conditions across 9 domains, 71 test files.
...
**Root** — `index.html` (565), `css/entopic.css` (2543)
...
**`/js`** — 82 files, in load order:

- `dom-escape.js` (67)
- `build-info.js` (78)
- `browser-io.js` (101)
- `kb-authoring.js` (312)
- `data-classification.js` (176)
- `events.js` (86)
- `data-model.js` (1275)
- `wnl-templates.js` (67)
