...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 112 loaded files (90 in `js/`, 22 in
`knowledge/`), 394 conditions across 9 domains, 79 test files.
...
**Root** — `index.html` (589), `css/entopic.css` (2601)
