...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 104 loaded files (83 in `js/`, 21 in
`knowledge/`), 394 conditions across 9 domains, 72 test files.
...
**Root** — `index.html` (568), `css/entopic.css` (2543)
