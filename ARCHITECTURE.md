...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 115 loaded files (92 in `js/`, 23 in
`knowledge/`), 394 conditions across 9 domains, 81 test files.
...
**Root** — `index.html` (600), `css/entopic.css` (2604)
...
**`/js`** — 92 files, in load order:

- `dom-escape.js` (67)
- `build-info.js` (78)
- `browser-io.js` (101)
- `kb-authoring.js` (312)
- `data-classification.js` (217)
- `events.js` (86)
- `data-model.js` (1275)
- `wnl-templates.js` (67)
...
- `feedback.js` (257)
- `storage.js` (916)
- `storage-backup.js` (411)
- `storage-migrations.js` (278)
- `visit-history.js` (212)
- `clinical-contradictions.js` (229)
- `kb-overlay.js` (423)
- `competency.js` (311)
- `ui-trends.js` (88)
- `ui-storage-banners.js` (170)
- `age-brackets.js` (136)
- `auth-crypto.js` (167)
- `clinic-mode.js` (231)
- `roles.js` (370)
