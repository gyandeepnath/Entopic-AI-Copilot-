...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 100 loaded files (79 in `js/`, 21 in
`knowledge/`), 394 conditions across 9 domains, 68 test files.
...
**Root** — `index.html` (557), `css/entopic.css` (2518)
