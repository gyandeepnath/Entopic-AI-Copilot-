...
**Covers build:** Entopic v1.5.0, KB v1.3.1 — 117 loaded files (94 in `js/`, 23 in
...
**Root** — `index.html` (623), `css/entopic.css` (2604)
...
**`/js`** — 94 files, in load order:

- `dom-escape.js` (67)
- `build-info.js` (78)
- `browser-io.js` (101)
- `kb-authoring.js` (312)
- `data-classification.js` (227)
- `events.js` (86)
- `data-model.js` (1275)
- `wnl-templates.js` (67)
