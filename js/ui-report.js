...
function pgRpt() {
  ...
  /* Active optional modules and specialty-clinic sections — ABOVE the
     signature. They used to print after it, i.e. outside what the clinician
     signs, so a screening outcome such as "Refer urgently" sat below the
     signed part of the document. */
